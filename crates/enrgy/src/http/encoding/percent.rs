...
//!
//! ```
//! use enrgy::http::encoding::percent::{utf8_percent_encode, AsciiSet, CONTROLS};
//!
...
///
/// ```
/// use enrgy::http::encoding::percent::{AsciiSet, CONTROLS};
///
/// /// https://url.spec.whatwg.org/#fragment-percent-encode-set
/// const FRAGMENT: &AsciiSet = &CONTROLS.add(b' ').add(b'"').add(b'<').add(b'>').add(b'`');
/// ```
...
///
/// ```
/// use enrgy::http::encoding::percent::percent_encode_byte;
///
...
///
/// ```
/// use enrgy::http::encoding::percent::{percent_encode, NON_ALPHANUMERIC};
///
...
///
/// ```
/// use enrgy::http::encoding::percent::{utf8_percent_encode, NON_ALPHANUMERIC};
///
...
///
/// ```
/// use enrgy::http::encoding::percent::percent_decode;
///
